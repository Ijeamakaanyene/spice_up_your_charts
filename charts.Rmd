...
ADD GRAPHIC WITH COVER ART - cross out taking the next steps and change to "Spicing up" 
...
background-image: url("images/toronto_data_05.png")
background-position: top
background-size: cover
background-color: var(--BlueGreen)
class: left, middle
...
**github.com/Ijeamakaanyene/spice_up_ya_dataviz**  
**@ijeamaka_a**
]