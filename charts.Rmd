...
#### Create standard chart as backup
]
]

```{r out.width='55%'}
knitr::include_graphics(path = here::here("images", "artsy_fartsy_plot3.png"))
```
...
```{r out.width='55%'}
knitr::include_graphics(path = here::here("images", "artsy_fartsy_plot2.png"))
```
